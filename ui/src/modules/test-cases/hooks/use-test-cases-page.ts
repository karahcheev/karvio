...
export function useTestCasesPage() {
  ...
  return {
    ...
    bulkActions: {
      ...
      bulkApplyProduct: bulkActions.bulkApplyProduct,
      bulkApplyComponents: bulkActions.bulkApplyComponents,
      ...
      bulkProductId: bulkActions.bulkProductId,
      bulkComponentIds: bulkActions.bulkComponentIds,
      suites: suiteTree.suitesWithMeta,
      ownerOptions: data.ownerOptions,
      productOptions: data.productOptions,
      componentOptions: data.componentOptions,
      ...
      onBulkApplyProductChange: bulkActions.setBulkApplyProduct,
      onBulkApplyComponentsChange: bulkActions.setBulkApplyComponents,
      ...
      onBulkProductIdChange: bulkActions.setBulkProductId,
      onBulkComponentIdsChange: bulkActions.setBulkComponentIds,
