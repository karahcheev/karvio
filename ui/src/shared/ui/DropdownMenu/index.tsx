...
// Radix Dropdown Menu with items, checkboxes, radio groups, and nested submenus.
...
// Selectable rows: plain, checkbox, radio
...
>) {
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "focus:bg-[var(--accent)] focus:text-[var(--accent-foreground)] data-[variant=destructive]:text-[var(--destructive)] data-[variant=destructive]:focus:bg-[color-mix(in_srgb,var(--destructive),transparent_90%)] dark:data-[variant=destructive]:focus:bg-[color-mix(in_srgb,var(--destructive),transparent_80%)] data-[variant=destructive]:focus:text-[var(--destructive)] data-[variant=destructive]:*:[svg]:!text-[var(--destructive)] [&_svg:not([class*='text-'])]:text-[var(--muted-foreground)] relative flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
...
>) {
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-[var(--accent)] focus:text-[var(--accent-foreground)] data-[state=open]:bg-[var(--accent)] data-[state=open]:text-[var(--accent-foreground)] flex cursor-pointer items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8",
        className,
      )}
      {...props}
    >
