...
Use this page before deciding how many projects to create, how to organize suites, and how to separate reusable plans from one-time runs.
...
Use one project per product, application, or delivery stream when access, release cadence, and reporting are shared.
...
Plans are useful for recurring scopes such as regression suites, smoke tests, UAT, and release acceptance.
