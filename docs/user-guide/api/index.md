...
Start with [Authorization](authorization.md), then open the resource page for the data you need. Resource pages list endpoints, required permissions, request fields, response fields, status codes, retry notes, limits, and destructive-operation behavior where relevant.
